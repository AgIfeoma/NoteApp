...
class AboutDialog(QDialog):
    def __init__(self, parent=None):
        ...
        # Имя автора
        author_label = QLabel("Автор: Ifeoma Agbowu", self)
        author_label.setStyleSheet("font-size: 12pt;")
        layout.addWidget(author_label)

        # GitHub
        github_label = QLabel('<a href="https://github.com/AgIfeoma/NoteApp/tree/develop">GitHub: https://github.com/AgIfeoma/NoteApp/tree/develop</a>', self)
